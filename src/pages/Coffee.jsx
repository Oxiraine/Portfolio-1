...
import BookmarkImg from '../assets/image-insure-hero.jpg'
import SupportPreviewImg from '../assets/image-insure-preview-1.jpg'
import SupportPreviewImgTwo from '../assets/image-insure-preview-2.jpg'
import HomeFooter from '../components/HomeFooter'
import InsureScrollBar from '../components/InsureScrollBar'
function Coffee() {
  return (
    <>
      <div className='support-banner'>
        ...
        <article className="manage-details">
          ...
          <div className="preview-top-line"></div>
            <h1 className='manage-header'>Insure</h1>
