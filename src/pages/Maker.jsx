...
import BookmarkImg from '../assets/image-fylo-hero.jpg'
import SupportPreviewImg from '../assets/image-fylo-preview-1.jpg'
import SupportPreviewImgTwo from '../assets/image-fylo-preview-2.jpg'
import HomeFooter from '../components/HomeFooter'
import MakerScrollBar from '../components/MakerScrollBar'
function Maker() {
  return (
    <>
      <div className='support-banner'>
        ...
        <article className="manage-details">
          ...
          <div className="preview-top-line"></div>
            <h1 className="manage-header">Fylo</h1>
