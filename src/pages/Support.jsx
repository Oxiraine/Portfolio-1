...
import ManageImg from '../assets/image-manage-hero.jpg'
import SupportPreviewImg from '../assets/image-manage-preview-1.jpg'
import SupportPreviewImgTwo from '../assets/image-manage-preview-2.jpg'
import HomeFooter from '../components/HomeFooter'
import ManageScrollBar from '../components/ManageScrollBar'
function Support() {
  return (
    <>
      <div className='support-banner'>
        <img src={ManageImg} className='manage-hero-img' alt="manage" />
      </div>
